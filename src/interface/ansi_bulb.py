...
def render_light_bulb(is_on: bool, brightness: float, engine_name: str = "Gemini 3.5 Flash") -> Panel:
    """Renders a dynamic ANSI ASCII light bulb with perfect symmetrical horizontal centering."""
    ...
    if not is_on or brightness <= 0.0:
        ...
        # 1% ~ 30%: High-Contrast Deep Orange / Amber
        ...
        # 71% ~ 100%: Blazing Brilliant White-Hot
    ...
    bulb_art = "\n".join(lines)
    art_text = Text(bulb_art, style=color, justify="center")
